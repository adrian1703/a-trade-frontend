  ...
  return (
    <Typography component={'div'}>
      <blockquote className={classes.quote}>
        ...
        <footer className={classes.author}>— Bruce Lee</footer>
      </blockquote>
      <p>
        To make a widget initially collapsed just add{' '}
        <code className={classes.highlighted}>collapsed</code> property to{' '}
        <code className={classes.highlighted}>.widget</code>.
      </p>
      <p>
        To make it locked (prevent dragging) add{' '}
        <code className={classes.highlighted}>.locked</code> class.
      </p>
    </Typography>
  );
};
